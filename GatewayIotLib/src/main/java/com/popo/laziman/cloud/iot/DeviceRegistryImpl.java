...
public class DeviceRegistryImpl extends GoogleCloudHelper {
	...
	public static List<CustomDevice> listDevices(String projectId, String cloudRegion, String registryName) throws Exception {
		...
		List<Device> devices = service.projects().locations().registries().devices().list(registryPath).setFieldMask("config,gatewayConfig,metadata").execute().getDevices();
	...
	public static void attachDeviceToGateway(MqttClient client, String deviceId) throws MqttException {
		// [START attach_device]
	...
	public static void detachDeviceFromGateway(MqttClient client, String deviceId) throws MqttException {
		// [START detach_device]
	...
	public static List<CustomDevice> listDevicesForGateway(String projectId, String cloudRegion, String registryName, String gatewayId) throws Exception {
		...
		List<Device> devices = service.projects().locations().registries().devices().list(registryPath).setFieldMask("config,gatewayConfig,metadata").setGatewayListOptionsAssociationsGatewayId(gatewayId).execute().getDevices();
